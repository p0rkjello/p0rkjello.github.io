...
[DuckDuckGo](https://duckduckgo.com/) is a search engine that reminds me of [Google](https://www.google.com/) from several years ago. One helpful feature is the !Bang command. You can use it to set options or search specific sites.
...
### Tech
    ...
    * **Languages (Matlab):** !matlab !matlabfx
